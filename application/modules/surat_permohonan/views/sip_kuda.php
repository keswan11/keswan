...
<table width="100%" align="center" class="font10">
	<tr>
		...
		Nomor: SIP-DRH KUDA 
			...
			endforeach;}?>  
			/ 
			<?php if (!empty($no_surat_sip_kuda)) {
				foreach ($no_surat_sip_kuda as $r) :
				?><?php echo $r->jumlah+1;?>
			<?php
			endforeach;}?> 
			 / PKH 
	...
	<tr>
		<td><br><p class="font10">Berdasarkan Peraturan Menteri Pertanian Nomor:................. tentang ............................., yang bertanda tangan di bawah ini Direktur Jenderal Peternakan dan Kesehatan Hewan/Kepala Dinas.................... Provinsi................*) memberikan IZIN PRAKTIK DOKTER HEWAN KUDA kepada:
		</p></td>
	</tr>
	<tr>
...
<table width="100%" class="font10">
	...
	<tr>
		<td>Masa Berlaku SIP-DRH Kuda</td>
		<td> : </td>
	</tr>
	<tr>
		<td>Untuk Praktik</td>
