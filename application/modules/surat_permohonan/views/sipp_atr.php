...
<table width="100%" align="center" class="font10">
	<tr>
		<td>
			...
			endforeach;}?>  
			/ 
			<?php if (!empty($no_surat_sipp_atr)) {
				foreach ($no_surat_sipp_atr as $r) :
				?><?php echo $r->jumlah+1;?>
			<?php
			endforeach;}?> 
			 / PKH 
	...
	<tr>
		<td><p class="font10">Berdasarkan Peraturan Menteri Pertanian Nomor:...................... tentang ........................................, yang bertanda tangan di bawah ini Kepala Dinas..................... Kab/Kota................ Provinsi................
			memberikan IZIN PELAYANAN TEKNIK REPRODUKSI kepada :
		</p></td>
	</tr>
	<tr>
		<td><br><p align="center" class="font14"><b>
...
<table width="100%" class="font10">
	...
	<tr>
		<td>Masa Berlaku SIPP-ATR1)</td>
		<td> : </td>
	</tr>
	<tr>
		<td>Untuk Pelayanan</td>
		<td> : Inseminasi Buatan, Pemeriksaan Kebuntingan dan Teknik Reproduksi</td>
	</tr>
	<tr>
		<td>Wilayah Kerja </td>
		<td> : </td>
