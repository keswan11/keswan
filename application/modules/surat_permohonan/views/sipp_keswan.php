...
<table width="100%" align="center" class="font10">
	<tr>
		<td>
			...
			endforeach;}?>  
			/ 
			<?php if (!empty($no_surat_sipp_keswan)) {
				foreach ($no_surat_sipp_keswan as $r) :
				?><?php echo $r->jumlah+1;?>
			<?php
			endforeach;}?> 
			 / PKH 
	...
	<tr>
		<td><p class="font10">Berdasarkan Peraturan Menteri Pertanian Nomor:.................. tentang ........................................, yang bertanda tangan di bawah ini Kepala Dinas.................. Kab/Kota............. Provinsi.............. memberikan IZIN PELAYANAN PARAMEDIK VETERINER KESEHATAN HEWAN kepada:	
		</p></td>
	</tr>
	<tr>
...
<table width="100%" class="font10">
	...
	<tr>
		<td>Nama Tempat Pelayanan Paramedik Keswan</td>
		<td> : </td>
	</tr>
	<tr>
		<td>Alamat Tempat Pelayanan Paramedik Keswan</td>
		<td> : </td>
	</tr>
	<tr>
	...
	<tr>
		<td>Masa Berlaku SIPP-Keswan</td>
		<td> : </td>
	</tr>
	<tr>
		<td>Untuk Pelayanan</td>
		<td> : Paramedik Kesehatan Hewan </td>
	</tr>
	<tr>
		<td>Wilayah Kerja </td>
		<td> : </td>
