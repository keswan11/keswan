<html><head>
	...
	<p class="font10" align="center"><b>Kop Dinas Kab/Kota</b></p><br><br><hr>
</head><body>
<table width="100%" align="center" class="font10">
	<tr>
		<td>
			<p align="center"  class="font11"><b>SURAT IZIN PARAMEDIK VETERINER PELAYANAN INSEMINATOR <br>
				(SIPP INSEMINATOR)<br>
			Nomor: SIPP-INSEMINATOR 
			...
			endforeach;}?>  
			/ 
			<?php if (!empty($no_surat_sipp_inseminator)) {
				foreach ($no_surat_sipp_inseminator as $r) :
				?><?php echo $r->jumlah+1;?>
			<?php
			endforeach;}?> 
			 / PKH 
	...
	<tr>
		<td><p class="font10">Berdasarkan Peraturan Menteri Pertanian Nomor:...................... tentang ............................................, maka yang bertanda tangan di bawah ini Kepala Dinas..................... Kab/Kota................ Provinsi................ memberikan IZIN PELAYANAN INSEMINASI BUATAN kepada :	
		</p></td>
	</tr>
	<tr>
...
<table width="100%" class="font10">
	...
	<tr>
		<td>Masa Berlaku SIPP Inseminator</td>
		<td> : </td>
	</tr>
	<tr>
		<td>Untuk Pelayanan</td>
		<td> : Inseminasi Buatan </td>
	</tr>
	<tr>
		<td>Wilayah Kerja </td>
		<td> : </td>
...
<table class="font10">
	<tr>
		<td>
			...
			<small> Keterangan<br>
			1)	Harus sama dengan masa berlaku kontrak penyelia</small>
		</td>
	</tr>
</table>
