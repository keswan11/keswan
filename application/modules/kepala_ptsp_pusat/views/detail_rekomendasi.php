...
<section class="content">
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      $get_id_wilayah=$this->Kepala_ptsp_pusat_model->get_id_wilayah_pengajuan($id_pengajuan, 'rekomendasi');
      echo '
      ...
      ?>
      <?php
      //$stat_pengajuan=$this->Kepala_ptsp_pusat_model->get_status_rekomendasi($id_pengajuan);
      ...
      <div class="box box-widget widget-user">
            ...
            <div class="box-body">
              ...
              foreach($data_kat_pesyaratan as $dkat)
              {
                ...
                foreach($this->Kepala_ptsp_pusat_model->get_subkat_persyaratan($id_jenis_pengajuan,$dkat->id_kategori_jenis_peralatan) as $dsub)
                {
                  if($dsub->id_sub_kategori_jenis_peralatan!=1)
                  {
                    echo '<li>'.$dsub->nama_sub_kategori_jenis_peralatan;
                    echo '<ul type="square">';
                    foreach($this->Kepala_ptsp_pusat_model->get_persyaratan($id_jenis_pengajuan,$dkat->id_kategori_jenis_peralatan,$dsub->id_sub_kategori_jenis_peralatan) as $syarat)
                    {
                      $data_keterangan=$this->Kepala_ptsp_pusat_model->get_keterangan_peralatan($id_jenis_pengajuan,$id_pengajuan,$syarat->id_jenis_peralatan);
                      foreach($data_keterangan as $dket)
                      {
                        echo '<li>'.ucwords($syarat->nama_peralatan).
                 			  '<br><b><text style="margin-left:30px; font-size:14px;">Jumlah '.$this->Kepala_ptsp_pusat_model->get_jumlah_persyaratan($id_jenis_pengajuan,$id_pengajuan,$syarat->id_jenis_peralatan).'</text></b>
