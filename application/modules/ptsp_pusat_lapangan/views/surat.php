                      ...
                      <?php
                        ...
                        if( $end_adm_lap != 'Administrasi' && $end_adm_lap != 'Lapangan' ){
                          ...
                          if( $data->id_status_pengajuan <> 5 ){
                             echo anchor(site_url($this->uri->segment(1)."/disposisi_surat/".$status_surat_function."/".$data->id_pengajuan), $status[($data->id_status_pengajuan - 1) + 1], array('class' => 'btn btn-block btn-info'));
                          }else{
