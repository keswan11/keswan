<section class="content">
  <div class="box box-info">
    ...
    <form method="post" action="<?php echo base_url()?>page_operator/input_sip_drhk">
         ...
         //Get Nama Wilayah
          ...
          <div class="box-body">
            <table id="table" class="table table-bordered">
              ...
              <tr>
                <td colspan="3">
                      <br><p class="font10">Berdasarkan Peraturan Menteri Pertanian Nomor: <input type="text" name="nomor_peraturan" required> tentang <input type="text" name="tentang" required> , yang bertanda tangan di bawah ini Direktur Jenderal Peternakan dan Kesehatan Hewan/Kepala Dinas <input type="text" name="kepala_dinas" required>  
                         <?php
                 if($hitung >= 3){
              ...
              <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"> <input type="text" name="nama_pos_ib" required></td>
                </tr>
                <tr>
                  <td width="35%">Alamat Tempat Praktik</td>
                  <td colspan="2"> <input type="text" name="alamat_pos_ib" required></td>
                </tr>
                <tr>
                  <td width="35%">Jenis Praktik</td>
                  <td colspan="2">
                    <select name="nama_dokter_hewan_penyelia">
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="text" name="no_sip_dokter_hewan_penyelia" required></td>
                </tr>
                <tr>
                  <td width="35%">Masa Berlaku SIP-DRH(K)</td>
                  <td colspan="2"><input type="text" name="masa_berlaku_kontrak_penyelia" required></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"> <input type="text" name="wilayah_kerja" required></td>
                </tr>
                <tr>
                  <td width="35%">Waktu Praktik</td>
                  <td colspan="2"> Pukul <input type="text" name="waktu_pelayanan" required></td>
                </tr>
                <tr>
                  <td width="35%"></td>
                  <td width="30%">
                    ...
                    <p align="right"><img width="80px" height="120px" src="<?php echo base_url();?>/images/<?php echo $images->isi_biodata_member;?>"></p>
                  </td>
                  <td>
                    Ditetapkan di : <?php echo $q2->nama_wilayah;?><br>
                    Pada Tanggal : <?php echo longdate_indo('Y-m-d');?><br>
                    Direktur Jenderal Peternakan dan Kesehatan Hewan/ Kepala Dinas <br><br><br>
                    NIP : <input type="text" name="nip" required>
                  </td>
                </tr>
                <tr>
                  <td colspan="3">
