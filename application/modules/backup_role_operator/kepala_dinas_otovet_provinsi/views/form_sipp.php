<section class="content">
	<form action="<?php echo base_url();?>Kepala_dinas_otovet_provinsi/input_data_sipp" method="post">
	<div class="box box-info">

	<div class="box-header">
		<h2><b><p align="center">Kop DInas Kota/Kab</p></b></h2><br><br>
	</div>
	<div class="box-body">
...
";
		...
		<td width="80px" height="120px">
			<?php $query = "SELECT isi_biodata_member FROM tb_data_member WHERE id_member = $r->id_member AND id_biodata_member = 17";
			$data = $this->db->query($query)->row();
			?>
