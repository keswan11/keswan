      ...
      <h3 class="box-title">Detail Surat Izin
		...
		<div class="row">
		  ...
		  foreach($data_wilayah as $dwilayah)
		  {
			...
			{
			  echo '<h4 class="col-sm-7" style="margin-left:14px;" > :'.$dwilayah->nama_wilayah.'</h4>';
			}
		  }
		  ...
		  <?php foreach($data_list_surat_izin as $dlist)
		  {
			...
			{
			  $detail_wilayah='<h4 class="col-sm-4" style="margin-left:14px;"> :'.$dlist->detail_wilayah.'</h4>';
			  echo '
				...
				<div class="row">
				  ...
				  if(count($data_member!=0))
				  {
					...
					foreach($data_member as $dmember)
					{
					  if($i==1 || $i==8)
					  {
						echo '<div ><table  style="margin-left:30px;">';
