...
<section class="content">
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      $get_id_wilayah=$this->Ptsp_kabupaten_atau_kota_administrasi_model->get_id_wilayah_pengajuan($id_pengajuan, 'izin');
      echo '
    ...
    <div class="box box-widget widget-user">
          ...
          <div class="box-body">
            ...
            {
              $isi_data=$this->Ptsp_kabupaten_atau_kota_administrasi_model->get_isi_persyaratan($id_pengajuan,$syarat->id_jenis_persyaratan);
