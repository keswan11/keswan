...
<section class="content">
  <div class="box box-primary">
    ...
    <?php
      echo form_open_multipart($this->uri->segment(1).'/detail_surat_izin','class="form-horizontal"');
    ?>
 
    <div class="box-body">

      <?php
      $data_wilayah=$this->Dinas_otovet_kabupaten_atau_kota_administrasi_model->get_wilayah();
      $get_id_wilayah=$this->Dinas_otovet_kabupaten_atau_kota_administrasi_model->get_id_wilayah_pengajuan($id_pengajuan, 'izin');
      echo '
      ...
      <div class="box box-widget widget-user">
            ...
            <div class="box-body">
              ...
              <?php
              $data_member=$this->Dinas_otovet_kabupaten_atau_kota_administrasi_model->get_member_by_id($id_member);
    ...
    <div class="box box-widget widget-user">
          ...
          <div class="box-body">
            <?php 
            foreach($data_pesyaratan as $syarat)
            {
              $isi_data=$this->Dinas_otovet_kabupaten_atau_kota_administrasi_model->get_isi_persyaratan($id_pengajuan,$syarat->id_jenis_persyaratan);
              foreach($isi_data as $isi)
              {
                if($isi->nama_jenis_input!="file")
                {
                  $isi_data_persyaratan=$isi->isi_jenis_persyaratan;
                  echo '<b style="margin-left:30px;">'.$syarat->nama_jenis_persyaratan.' '.$isi_data_persyaratan.'</b>';
                  echo '<br><br>';
                }
                else
                {
                  ...
                  echo '<b style="margin-left:30px;">'.$syarat->nama_jenis_persyaratan.'</b>';
                  echo '<a target="blank" href="'.$isi_data_persyaratan.'"> <i class="fa fa-download"> Unduh file</i></a><br><br>';
                ...
                <textarea '.$disable_adm.' style="margin-left:30px; font-size:13.5px; width:300px;" class="form-control" rows="4" name="'.$syarat->id_jenis_persyaratan.'_adm">'.$isi->ket_adm.'</textarea>
                </div>

                <div class="col-md-6">
                <b><text style="margin-left:30px; font-size:12px;">Keterangan Operator Lapangan<text></b>
                <textarea '.$disable_lap.' style="margin-left:30px; font-size:13.5px; width:300px;" class="form-control" rows="4" name="'.$syarat->id_jenis_persyaratan.'_lap">'.$isi->ket_lap.'</textarea>
                <br>
                </div>
                ...
                // <div class="form-group">
                // <div class="col-sm-4 ">
                //   <text style="margin-left:50px; font-size:14px;">Keterangan Administrasi<text></b>
                // </div>
                //   <div>
                //   <textarea style="margin-left:30px; font-size:13.5px; width:400px;" class="form-control" rows="4" name="'.$syarat->id_jenis_persyaratan.'_adm">'.$isi->ket_adm.'</textarea>
                //   </div>
                // </div>';
                // echo '
                // <div class="form-group">
                //   <div class="col-sm-4 ">
                //     <text style="margin-left:50px; font-size:14px;">Keterangan Operator Lapangan<text></b>
                //   </div>
                //   <div>
                //   <textarea style="margin-left:30px; font-size:13.5px; width:400px;" class="form-control" rows="4" name="'.$syarat->id_jenis_persyaratan.'_lap">'.$isi->ket_lap.'</textarea>
                //   </div>
                // </div>
                // <br>';
              }
