...
<section class="content">
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      <?php
      $data_wilayah=$this->Dinas_otovet_provinsi_lapangan_model->get_wilayah();
      $get_id_wilayah=$this->Dinas_otovet_provinsi_lapangan_model->get_id_wilayah_pengajuan($id_pengajuan, 'izin');
      echo '
      ...
      <div class="box box-widget widget-user">
            ...
            <div class="box-body">
              ...
              <?php
              $data_member=$this->Dinas_otovet_provinsi_lapangan_model->get_member_by_id($id_member);
    ...
    <div class="box box-widget widget-user">
          ...
          <div class="box-body">
            ...
            {
              $isi_data=$this->Dinas_otovet_provinsi_lapangan_model->get_isi_persyaratan($id_pengajuan,$syarat->id_jenis_persyaratan);
